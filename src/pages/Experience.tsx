...
const experiences = [
  ...
  },
  {
    ...
    role: 'Tutor',
    type: 'Freelance',
    description: 'Conducted short-term online tutoring for students from Australia on topics including Python, LLMs, Tinkercad, Computing Basics, Web Designing, Canva, and Mathematics.',
    tech: ['Python', 'Web Design', 'Teaching'],
    achievements: [
      'Taught international students across multiple subjects',
      'Delivered hands-on sessions in web design and programming',
      'Provided personalized learning experiences',
    ],
  },
];
