...
const projects = [
  {
    title: 'ScamShield',
    slug: 'scamshield',
    description: '🏆 Top 12 Finalist (out of 87 teams) - RBI Innovation Hub & IIT Delhi National Fraud Prevention Challenge. AI-powered money mule detection system.',
    role: 'Data Scientist & ML Engineer — Fraud Analytics & Pattern Detection',
    tech: ['Python', 'Machine Learning', 'Graph Analysis', 'Ensemble Models', 'Fraud Detection'],
    highlights: [
      '🏆 Top 12 Finalist out of 87 teams - Final Round at IIT Delhi',
      'Processed 400M+ banking transactions through AI pipeline',
      'Public AUC: 0.98, F1: 0.85 | Private AUC: ~1.0, F1: 0.93+',
      'Fraud Lifecycle Model + Transaction Network Graph Analysis',
