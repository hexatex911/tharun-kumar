...
const projects = [
  {
    title: 'ScamShield',
    slug: 'scamshield',
    description: '🏆 IIT Delhi Finalist - RBIH × IIT Delhi National Fraud Prevention Challenge. Multi-layer AI pipeline detecting money mule accounts used for laundering illicit funds.',
    role: 'Data Scientist & ML Engineer — Fraud Analytics & Pattern Detection',
    tech: ['LightGBM', 'XGBoost', 'NetworkX', 'SHAP', 'PyArrow', 'Python'],
    highlights: [
      '🏆 IIT Delhi Finalist - Top 12 out of 87 teams',
      'AUC-ROC: 0.9424 | F1 Score: 0.6816 | 400M+ Transactions',
      'FLSM Engine: 5-state fraud lifecycle tracking',
      'Graph Intelligence: 2.8M+ edges with PageRank analysis',
      'RH Defense: 7-category taxonomy preventing false positives',
      'Ensemble: LightGBM + XGBoost + Platt calibration on 164 features',
    ],
