    ...
    >
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 right-4 z-10 p-2 rounded-lg bg-background/80 backdrop-blur hover:bg-muted transition-colors group"
        >
          <X className="h-5 w-5" />
        ...
        <div className="flex flex-col md:flex-row h-full max-h-[90vh]">
          {/* Left Pane - Image Carousel (50%) */}
          <div className="w-full md:w-1/2 bg-muted/30 relative flex flex-col">
            {/* Image Display */}
            ...
            {/* Image Counter */}
            <div className="absolute top-4 left-4 px-3 py-1 bg-background/80 backdrop-blur rounded-full text-sm">
              {currentImageIndex + 1} / {project.images.length}
            </div>
          </div>

          {/* Right Pane - Content (50%) */}
